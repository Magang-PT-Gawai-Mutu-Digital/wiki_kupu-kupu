      ...
      {dataKupu?.map((dataKupu, index) => (
        <section className="body-font py-4">
          <div className="container px-8 py-4 mx-auto">
            <div className="flex w-full mb-4 flex-wrap laptop:text-left phone:text-center">
              <h1 className="w-full phone:text-3xl text-2xl uppercase font-medium title-font laptop:w-1/3 laptop:mb-0 mb-4">
                  ...
                  <>
                    {item.species?.map((spesies, index) => (
                      <div className="laptop:w-1/4 phone:w-1/2 p-4">
                        <div className="w-full rounded-lg shadow-xl flex flex-col items-center gap-2 pb-2 transform duration-700 ease-in-out hover:-translate-y-1 hover:scale-110" >
                          <img
                            key={index}
